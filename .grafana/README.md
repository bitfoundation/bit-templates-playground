# Azure Application Insights - Grafana Dashboard Bit.TemplatePlayground

This repository contains a production-ready Grafana Dashboard Bit.TemplatePlayground tailored for applications integrated with **Azure Application Insights (Log Analytics Workspace)**. It provides deep visibility into application health, performance metrics, and system exceptions using Kusto Query Language (KQL).
...
Unlike standard dashboards that lump all errors together, this bit.templateplayground splits exceptions into clear, actionable categories:
