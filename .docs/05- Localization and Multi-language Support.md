...
#### Server API Resources (`src/Server/Bit.TemplatePlayground.Server.Api/Resources/`)
...
**Base class location**: `src/Server/Bit.TemplatePlayground.Server.Api/Controllers/AppControllerBase.cs`
