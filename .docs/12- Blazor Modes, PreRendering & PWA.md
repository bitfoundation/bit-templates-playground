...
Welcome to Stage 12 of the Bit.TemplatePlayground project tutorial! In this stage, you'll learn about Blazor rendering modes, pre-rendering capabilities, Progressive Web App (PWA) features, and how they all work together in this project.
...
1. **[`/src/Server/Bit.TemplatePlayground.Server.Web/Components/App.razor`](/src/Server/Bit.TemplatePlayground.Server.Web/Components/App.razor)** - The main entry point for Blazor Server, WebAssembly, Auto and Static SSR
2. **[`/src/Client/Bit.TemplatePlayground.Client.Web/wwwroot/index.html`](/src/Client/Bit.TemplatePlayground.Client.Web/wwwroot/index.html)** - The entry point for Blazor WebAssembly standalone mode
3. **[`/src/Client/Bit.TemplatePlayground.Client.Maui/wwwroot/index.html`](/src/Client/Bit.TemplatePlayground.Client.Maui/wwwroot/index.html)** - The entry point for Blazor Hybrid / MAUI
...
<link href="_content/Bit.TemplatePlayground.Client.Core/styles/app.css" rel="stylesheet" />
```
...
**File**: [`/src/Client/Bit.TemplatePlayground.Client.Web/wwwroot/service-worker.published.js`](/src/Client/Bit.TemplatePlayground.Client.Web/wwwroot/service-worker.published.js)
