...
**File**: [`src/Server/Bit.TemplatePlayground.Server.Api/Infrastructure/Controllers/AppControllerBase.cs`](/src/Server/Bit.TemplatePlayground.Server.Api/Infrastructure/Controllers/AppControllerBase.cs)
...
3. **Cleaner Code**: Less bit.templateplayground, more focus on business logic.

### Example from CategoryController

**File**: [`src/Server/Bit.TemplatePlayground.Server.Api/Features/Categories/CategoryController.cs`](/src/Server/Bit.TemplatePlayground.Server.Api/Features/Categories/CategoryController.cs)
...
**File**: [`src/Client/Bit.TemplatePlayground.Client.Core/Infrastructure/Services/ODataQuery.cs`](/src/Client/Bit.TemplatePlayground.Client.Core/Infrastructure/Services/ODataQuery.cs)
...
**File**: [`src/Client/Bit.TemplatePlayground.Client.Core/Components/Pages/Products/ProductsPage.razor.cs`](/src/Client/Bit.TemplatePlayground.Client.Core/Components/Pages/Products/ProductsPage.razor.cs)
...
**File**: [`src/Server/Bit.TemplatePlayground.Server.Api/Features/Products/ProductController.cs`](/src/Server/Bit.TemplatePlayground.Server.Api/Features/Products/ProductController.cs)
...
2. Implement the interface in `src/Server/Bit.TemplatePlayground.Server.Api/Features/{Feature}/` (server-side)
