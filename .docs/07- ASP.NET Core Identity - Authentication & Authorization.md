...
By default, the project is configured to connect to a **demo Duende Identity Server 8 instance** to demonstrate how external OpenID Connect providers work. The implementation is in [`IdentityController.SocialSignIn.cs`](/src/Server/Bit.TemplatePlayground.Server.Api/Controllers/Identity/IdentityController.SocialSignIn.cs).
...
From [`IdentityController.SocialSignIn.cs`](/src/Server/Bit.TemplatePlayground.Server.Api/Controllers/Identity/IdentityController.SocialSignIn.cs):
...
From [`IdentityController.ResetPassword.cs`](/src/Server/Bit.TemplatePlayground.Server.Api/Controllers/Identity/IdentityController.ResetPassword.cs):
