...
This stage explains how Dependency Injection (DI) is structured in the Bit.TemplatePlayground project and where services are registered for different platforms and environments.
...
2. **`IClientCoreServiceCollectionExtensions.cs`** ([`src/Client/Bit.TemplatePlayground.Client.Core/Infrastructure/Extensions/`](/src/Client/Bit.TemplatePlayground.Client.Core/Infrastructure/Extensions/IClientCoreServiceCollectionExtensions.cs))
...
4. **Platform-specific extensions** (MAUI only)
   ...
   |---------------|----------|
   | [`IAndroidServiceCollectionExtensions.cs`](/src/Client/Bit.TemplatePlayground.Client.Maui/Platforms/Android/Extensions/IAndroidServiceCollectionExtensions.cs) | Android-specific services (e.g., `AndroidPushNotificationService`) |
   | [`IIosServiceCollectionExtensions.cs`](/src/Client/Bit.TemplatePlayground.Client.Maui/Platforms/iOS/Extensions/IIosServiceCollectionExtensions.cs) | iOS-specific services |
   | [`IMacServiceCollectionExtensions.cs`](/src/Client/Bit.TemplatePlayground.Client.Maui/Platforms/MacCatalyst/Extensions/IMacServiceCollectionExtensions.cs) | macOS-specific services |
   | [`IWindowsServiceCollectionExtensions.cs`](/src/Client/Bit.TemplatePlayground.Client.Maui/Platforms/Windows/Extensions/IWindowsServiceCollectionExtensions.cs) | Windows (MAUI)-specific services |
...
Located in [`IClientCoreServiceCollectionExtensions.cs`](/src/Client/Bit.TemplatePlayground.Client.Core/Infrastructure/Extensions/IClientCoreServiceCollectionExtensions.cs):
...
1. **Define the interface** in `Bit.TemplatePlayground.Shared` or `Bit.TemplatePlayground.Client.Core`
...
```csharp
// src/Client/Bit.TemplatePlayground.Client.Core/Infrastructure/Services/FeedbackService.cs
...
```csharp
// src/Client/Bit.TemplatePlayground.Client.Core/Infrastructure/Extensions/IClientCoreServiceCollectionExtensions.cs
