...
Located in [`IClientCoreServiceCollectionExtensions.cs`](/src/Client/Bit.TemplatePlayground.Client.Core/Extensions/IClientCoreServiceCollectionExtensions.cs):
...
```csharp
// src/Client/Bit.TemplatePlayground.Client.Core/Extensions/IClientCoreServiceCollectionExtensions.cs
