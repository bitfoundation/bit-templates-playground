...
In [`PhoneService.cs`](/src/Server/Bit.TemplatePlayground.Server.Api/Infrastructure/Services/PhoneService.cs):
...
In [`PhoneServiceJobsRunner.cs`](/src/Server/Bit.TemplatePlayground.Server.Api/Infrastructure/Services/PhoneServiceJobsRunner.cs):
