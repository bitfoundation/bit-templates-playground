...
Let's look at a real controller from the project - [`TodoItemController.cs`](/src/Server/Bit.TemplatePlayground.Server.Api/Controllers/Todo/TodoItemController.cs):
...
Let's examine how `CurrentCancellationToken` is implemented in [`AppComponentBase.cs`](/src/Client/Bit.TemplatePlayground.Client.Core/Components/AppComponentBase.cs):
...
Here's a real example from [`TodoPage.razor.cs`](/src/Client/Bit.TemplatePlayground.Client.Core/Components/Pages/TodoPage.razor.cs):
...
In [`PhoneService.cs`](/src/Server/Bit.TemplatePlayground.Server.Api/Services/PhoneService.cs):
...
In [`PhoneServiceJobsRunner.cs`](/src/Server/Bit.TemplatePlayground.Server.Api/Services/Jobs/PhoneServiceJobsRunner.cs):
...
In [`Program.Services.cs`](/src/Server/Bit.TemplatePlayground.Server.Api/Program.Services.cs):
