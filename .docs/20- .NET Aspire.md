...
Welcome to Stage 20! In this stage, you'll learn about .NET Aspire and how it transforms both development and deployment experiences in this Bit.TemplatePlayground project.
...
**Location**: [`src/Server/Bit.TemplatePlayground.Server.AppHost/`](/src/Server/Bit.TemplatePlayground.Server.AppHost/)
...
**Location**: [`src/Server/Bit.TemplatePlayground.Server.AppHost/appsettings.Development.json`](/src/Server/Bit.TemplatePlayground.Server.AppHost/appsettings.Development.json)
...
There's a ready-made line at the bottom of `Program.cs` in the `Bit.TemplatePlayground.Server.AppHost` project that keeps the containers themselves alive and reuses them instead - just uncomment it:
...
- ❌ `Bit.TemplatePlayground.Server.Api` **does NOT** run on Docker
- ❌ `Bit.TemplatePlayground.Server.Web` **does NOT** run on Docker
...
3. Run this command in the terminal to clean previous Windows build artifacts:
   ...
   ```
4. Then run the `Bit.TemplatePlayground.Server.AppHost` project
...
Which ones you get depends on the options you generated with; `Bit.TemplatePlayground.Server.AppHost.csproj` is the source of
