...
The test project is located at [`src/Tests/Bit.TemplatePlayground.Tests.csproj`](/src/Tests/Bit.TemplatePlayground.Tests.csproj) and contains:
...
<RunSettings>
    ...
    <RunConfiguration>
        <EnvironmentVariables>
            ...
            <ConnectionStrings__sqlite>Data Source=Bit.TemplatePlaygroundDb.db;Mode=Memory;Cache=Shared;</ConnectionStrings__sqlite>
        </EnvironmentVariables>
    </RunConfiguration>
</RunSettings>
```
...
```powershell
# Run all tests
dotnet test src/Tests/Bit.TemplatePlayground.Tests.csproj

# Run specific test
dotnet test src/Tests/Bit.TemplatePlayground.Tests.csproj --filter "FullyQualifiedName~SignInTest"

# Run with verbose output
dotnet test src/Tests/Bit.TemplatePlayground.Tests.csproj --logger "console;verbosity=detailed"
```
...
```yaml
- name: Run Tests
  run: dotnet test src/Tests/Bit.TemplatePlayground.Tests.csproj --configuration Release
