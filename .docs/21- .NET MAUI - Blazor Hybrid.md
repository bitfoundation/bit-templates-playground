...
**Location**: [`/src/Client/Bit.TemplatePlayground.Client.Web/wwwroot/apple-app-site-association`](/src/Client/Bit.TemplatePlayground.Client.Web/wwwroot/apple-app-site-association)
...
Implements `IStorageService` using MAUI's `Preferences` API in [`MauiStorageService.cs`](/src/Client/Bit.TemplatePlayground.Client.Maui/Services/MauiStorageService.cs):
...
Implements `IExternalNavigationService` for opening external URLs in [`MauiExternalNavigationService.cs`](/src/Client/Bit.TemplatePlayground.Client.Maui/Services/MauiExternalNavigationService.cs):
