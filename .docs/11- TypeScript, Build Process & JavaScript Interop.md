...
### Location
[`/src/Client/Bit.TemplatePlayground.Client.Core/tsconfig.json`](/src/Client/Bit.TemplatePlayground.Client.Core/tsconfig.json)
...
```jsonc
{
    /* Note for Developers:
        ...
        of the MSBuild process defined in the Bit.TemplatePlayground.Client.Core.csproj file's `BuildJavaScript` target.
    */
    "compilerOptions": {
        "strict": true,
        "target": "ES2019",
...
### Location
[`/src/Client/Bit.TemplatePlayground.Client.Core/package.json`](/src/Client/Bit.TemplatePlayground.Client.Core/package.json)
...
### Location
[`/src/Client/Bit.TemplatePlayground.Client.Core/Bit.TemplatePlayground.Client.Core.csproj`](/src/Client/Bit.TemplatePlayground.Client.Core/Bit.TemplatePlayground.Client.Core.csproj)
...
**Location:** [`/src/Client/Bit.TemplatePlayground.Client.Core/Scripts/App.ts`](/src/Client/Bit.TemplatePlayground.Client.Core/Scripts/App.ts)
...
**Location:** [`/src/Client/Bit.TemplatePlayground.Client.Core/Infrastructure/Extensions/IJSRuntimeExtensions.cs`](/src/Client/Bit.TemplatePlayground.Client.Core/Infrastructure/Extensions/IJSRuntimeExtensions.cs)
...
Run the following commands in the `Bit.TemplatePlayground.Client.Core` directory:

```powershell
cd src/Client/Bit.TemplatePlayground.Client.Core
npm install uuid
...
Add this import at the top and new method to the `App` class in [`Scripts/App.ts`](/src/Client/Bit.TemplatePlayground.Client.Core/Scripts/App.ts):
...
Add this method to [`Infrastructure/Extensions/IJSRuntimeExtensions.cs`](/src/Client/Bit.TemplatePlayground.Client.Core/Infrastructure/Extensions/IJSRuntimeExtensions.cs):
...
```powershell
cd src/Server/Bit.TemplatePlayground.Server.Web
dotnet build
```
