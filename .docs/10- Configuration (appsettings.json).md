...
- [`src/Client/Bit.TemplatePlayground.Client.Core/appsettings.json`](/src/Client/Bit.TemplatePlayground.Client.Core/appsettings.json) - Client-side shared configuration
...
- **Web Server**: has no appsettings files of its own. `Bit.TemplatePlayground.Server.Web.csproj` links the API Server's
  `appsettings*.json` above into its output directory, so those are the files it reads at runtime. Do not create
  `src/Server/Bit.TemplatePlayground.Server.Web/appsettings.json` - it would be copied to the same output path and which of the
...
In [`src/Client/Bit.TemplatePlayground.Client.Core/appsettings.json`](/src/Client/Bit.TemplatePlayground.Client.Core/appsettings.json), client-specific settings are defined:

```json
{
    "ServerAddress": "http://localhost:5000/",
    "ServerAddress_Comment": "If you're running Bit.TemplatePlayground.Server.Web project, then you can also use relative urls such as / for Blazor Server and WebAssembly",
...
In [`src/Client/Bit.TemplatePlayground.Client.Maui/appsettings.json`](/src/Client/Bit.TemplatePlayground.Client.Maui/appsettings.json):
...
In [`src/Server/Bit.TemplatePlayground.Server.Api/appsettings.json`](/src/Server/Bit.TemplatePlayground.Server.Api/appsettings.json), you'll find comprehensive server settings:

```json
{
    "ConnectionStrings": {
        "mssqldb": "Data Source=(localdb)\\mssqllocaldb; Initial Catalog=Bit.TemplatePlaygroundDb;...",
...
```json
{
    ...
    "ConnectionStrings": {
        "Aspire__Comment": "Running Bit.TemplatePlayground.Server.AppHost `overrides` the following connection strings at runtime.",
        "mssqldb": "Data Source=(localdb)\\mssqllocaldb; Initial Catalog=Bit.TemplatePlaygroundDb;...",
...
**From `src/Server/Bit.TemplatePlayground.Server.AppHost/appsettings.Development.json`:**
```json
{
    "Parameters": {
...
**From `src/Client/Bit.TemplatePlayground.Client.Core/appsettings.json`:**
```json
{
...
2. Override in platform-specific files:
   - For MAUI: [`src/Client/Bit.TemplatePlayground.Client.Maui/appsettings.json`](/src/Client/Bit.TemplatePlayground.Client.Maui/appsettings.json)
   - For Web: [`src/Client/Bit.TemplatePlayground.Client.Web/appsettings.json`](/src/Client/Bit.TemplatePlayground.Client.Web/appsettings.json)
   - For Windows: [`src/Client/Bit.TemplatePlayground.Client.Windows/appsettings.json`](/src/Client/Bit.TemplatePlayground.Client.Windows/appsettings.json)
