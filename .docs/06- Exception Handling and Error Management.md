...
Welcome to Stage 6! In this stage, you will learn about the comprehensive exception handling and error management system built into the Bit.TemplatePlayground project.
...
From [`src/Server/Bit.TemplatePlayground.Server.Api/Features/Identity/IdentityController.EmailConfirmation.cs`](/src/Server/Bit.TemplatePlayground.Server.Api/Features/Identity/IdentityController.EmailConfirmation.cs):
...
**Location:** [`src/Server/Bit.TemplatePlayground.Server.Api/Infrastructure/Extensions/KnownExceptionExtensions.cs`](/src/Server/Bit.TemplatePlayground.Server.Api/Infrastructure/Extensions/KnownExceptionExtensions.cs)
...
```json
{
  "type": "Bit.TemplatePlayground.Shared.Infrastructure.Exceptions.TooManyRequestsException",
...
From [`src/Server/Bit.TemplatePlayground.Server.Api/Features/Identity/IdentityController.cs`](/src/Server/Bit.TemplatePlayground.Server.Api/Features/Identity/IdentityController.cs):
...
From [`src/Client/Bit.TemplatePlayground.Client.Core/Components/Pages/Identity/SignIn/SignInPanel.razor.cs`](/src/Client/Bit.TemplatePlayground.Client.Core/Components/Pages/Identity/SignIn/SignInPanel.razor.cs):
...
**Location:** [`src/Client/Bit.TemplatePlayground.Client.Core/Components/AppComponentBase.cs`](/src/Client/Bit.TemplatePlayground.Client.Core/Components/AppComponentBase.cs)
...
From [`src/Client/Bit.TemplatePlayground.Client.Core/Components/Pages/Identity/SignIn/SignInPanel.razor`](/src/Client/Bit.TemplatePlayground.Client.Core/Components/Pages/Identity/SignIn/SignInPanel.razor):
...
**Handled by:** `BitMessageBoxService` in [`ClientExceptionHandlerBase`](/src/Client/Bit.TemplatePlayground.Client.Core/Infrastructure/Services/ClientExceptionHandlerBase.cs)
...
**Handled by:** `SnackBarService` in [`ClientExceptionHandlerBase`](/src/Client/Bit.TemplatePlayground.Client.Core/Infrastructure/Services/ClientExceptionHandlerBase.cs)
...
**Location:** [`src/Client/Bit.TemplatePlayground.Client.Core/Components/AppErrorBoundary.razor`](/src/Client/Bit.TemplatePlayground.Client.Core/Components/AppErrorBoundary.razor)
...
**Location:** [`src/Server/Bit.TemplatePlayground.Server.Api/Infrastructure/Services/ApiServerExceptionHandler.cs`](/src/Server/Bit.TemplatePlayground.Server.Api/Infrastructure/Services/ApiServerExceptionHandler.cs)
...
```json
{
  "type": "Bit.TemplatePlayground.Shared.Infrastructure.Exceptions.ResourceNotFoundException",
...
**Location:** [`src/Client/Bit.TemplatePlayground.Client.Core/Infrastructure/Services/ClientExceptionHandlerBase.cs`](/src/Client/Bit.TemplatePlayground.Client.Core/Infrastructure/Services/ClientExceptionHandlerBase.cs)
...
**Location:** [`src/Client/Bit.TemplatePlayground.Client.Web/Infrastructure/Services/WebClientExceptionHandler.cs`](/src/Client/Bit.TemplatePlayground.Client.Web/Infrastructure/Services/WebClientExceptionHandler.cs)
...
**Location:** [`src/Client/Bit.TemplatePlayground.Client.Maui/Infrastructure/Services/MauiExceptionHandler.cs`](/src/Client/Bit.TemplatePlayground.Client.Maui/Infrastructure/Services/MauiExceptionHandler.cs)
...
**Location:** [`src/Client/Bit.TemplatePlayground.Client.Windows/Infrastructure/Services/WindowsExceptionHandler.cs`](/src/Client/Bit.TemplatePlayground.Client.Windows/Infrastructure/Services/WindowsExceptionHandler.cs)
...
**Location:** [`src/Server/Bit.TemplatePlayground.Server.Web/Infrastructure/Services/WebServerExceptionHandler.cs`](/src/Server/Bit.TemplatePlayground.Server.Web/Infrastructure/Services/WebServerExceptionHandler.cs)
