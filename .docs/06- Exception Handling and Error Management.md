...
**Location:** [`src/Server/Bit.TemplatePlayground.Server.Api/Extensions/KnownExceptionExtensions.cs`](/src/Server/Bit.TemplatePlayground.Server.Api/Extensions/KnownExceptionExtensions.cs)
...
From [`src/Server/Bit.TemplatePlayground.Server.Api/Controllers/Identity/IdentityController.cs`](/src/Server/Bit.TemplatePlayground.Server.Api/Controllers/Identity/IdentityController.cs):
...
**Location:** [`src/Server/Bit.TemplatePlayground.Server.Api/Services/ServerExceptionHandler.cs`](/src/Server/Bit.TemplatePlayground.Server.Api/Services/ServerExceptionHandler.cs)
