...
```json
{
  "type": "Bit.TemplatePlayground.Shared.Exceptions.TooManyRequestsException",
...
**Handled by:** `BitMessageBoxService` in [`ClientExceptionHandlerBase`](/src/Client/Bit.TemplatePlayground.Client.Core/Services/ClientExceptionHandlerBase.cs)
...
**Handled by:** `SnackBarService` in [`ClientExceptionHandlerBase`](/src/Client/Bit.TemplatePlayground.Client.Core/Services/ClientExceptionHandlerBase.cs)
...
**Location:** [`src/Server/Bit.TemplatePlayground.Server.Api/Infrastructure/Services/ServerExceptionHandler.cs`](/src/Server/Bit.TemplatePlayground.Server.Api/Infrastructure/Services/ServerExceptionHandler.cs)
...
```json
{
  "type": "Bit.TemplatePlayground.Shared.Exceptions.ResourceNotFoundException",
...
**Location:** [`src/Client/Bit.TemplatePlayground.Client.Core/Services/ClientExceptionHandlerBase.cs`](/src/Client/Bit.TemplatePlayground.Client.Core/Services/ClientExceptionHandlerBase.cs)
...
**Location:** [`src/Client/Bit.TemplatePlayground.Client.Web/Services/WebClientExceptionHandler.cs`](/src/Client/Bit.TemplatePlayground.Client.Web/Services/WebClientExceptionHandler.cs)
...
**Location:** [`src/Client/Bit.TemplatePlayground.Client.Maui/Services/MauiExceptionHandler.cs`](/src/Client/Bit.TemplatePlayground.Client.Maui/Services/MauiExceptionHandler.cs)
...
**Location:** [`src/Client/Bit.TemplatePlayground.Client.Windows/Services/WindowsExceptionHandler.cs`](/src/Client/Bit.TemplatePlayground.Client.Windows/Services/WindowsExceptionHandler.cs)
