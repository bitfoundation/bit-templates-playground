...
```xml
<PackageVersion Include="Bit.BlazorUI" Version="10.4.3" />
```
...
```xml
<PackageVersion Include="Bit.BlazorUI" Version="10.4.3" />
<PackageVersion Include="Bit.Butil" Version="10.4.3" />
...
````markdown
This project gets generated by bit-bp template v-10.4.3 using the following command
```bash
dotnet new bit-bp
