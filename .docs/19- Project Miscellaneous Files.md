...
### 2.1 `Bit.TemplatePlayground.sln`

**Location**: [`/Bit.TemplatePlayground.sln`](/Bit.TemplatePlayground.sln)

**Purpose**: The **full solution file** for Visual Studio that includes ALL projects in the workspace.

**Contains**:
- Server projects (`Bit.TemplatePlayground.Server.Web`, `Bit.TemplatePlayground.Server.Api`, `Bit.TemplatePlayground.Server.Shared`, `Bit.TemplatePlayground.Server.AppHost`)
- Client projects (`Bit.TemplatePlayground.Client.Core`, `Bit.TemplatePlayground.Client.Web`, `Bit.TemplatePlayground.Client.Maui`, `Bit.TemplatePlayground.Client.Windows`)
- Shared project (`Bit.TemplatePlayground.Shared`)
- Tests project (`Bit.TemplatePlayground.Tests`)
...
### 2.2 `Bit.TemplatePlayground.Web.slnf`

**Location**: [`/Bit.TemplatePlayground.Web.slnf`](/Bit.TemplatePlayground.Web.slnf)
...
**Projects included**:
- `Bit.TemplatePlayground.Server.Web`
- `Bit.TemplatePlayground.Server.Api`
- `Bit.TemplatePlayground.Server.Shared`
- `Bit.TemplatePlayground.Server.AppHost`
- `Bit.TemplatePlayground.Client.Core`
- `Bit.TemplatePlayground.Client.Web`
- `Bit.TemplatePlayground.Shared`
- `Bit.TemplatePlayground.Tests`
...
### 2.3 `Bit.TemplatePlayground.slnx`

**Location**: [`/Bit.TemplatePlayground.slnx`](/Bit.TemplatePlayground.slnx)
...
<Using Include="Bit.TemplatePlayground.Shared.Infrastructure.Dtos" />
<Using Include="Bit.TemplatePlayground.Shared.Infrastructure.Exceptions" />
<!-- ... and many more -->
```
...
```xml
<PackageReference Include="Bit.BlazorUI" Version="10.6.0-pre-05" />
```
...
```xml
<PackageVersion Include="Bit.BlazorUI" Version="10.6.0-pre-05" />
```
...
```xml
<PackageVersion Include="Bit.BlazorUI" Version="10.6.0-pre-05" />
<PackageVersion Include="Bit.Butil" Version="10.6.0-pre-05" />
...
- **Default Solution**: Uses `Bit.TemplatePlayground.Web.slnf` for faster load times
...
- **`build`**: Builds the `Bit.TemplatePlayground.Server.Web` project
...
- **Custom Bit.TemplatePlayground patterns**:
  - `*Resource.designer.cs` (auto-generated from `.resx`)
  - `/src/Client/Bit.TemplatePlayground.Client.Core/Scripts/*.js` (generated from TypeScript)
  - `/src/Client/Bit.TemplatePlayground.Client.Maui/Platforms/Android/google-services.json` (sensitive Firebase config)
...
````markdown
This project gets generated by bit-bp template v-10.6.0-pre-05 using the following command
```bash
dotnet new bit-bp
