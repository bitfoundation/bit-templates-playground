...
```xml
<PackageReference Include="Bit.BlazorUI" Version="10.0.0" />
```
...
```xml
<PackageVersion Include="Bit.BlazorUI" Version="10.0.0" />
```
...
```xml
<PackageVersion Include="Bit.BlazorUI" Version="10.0.0" />
<PackageVersion Include="Bit.Butil" Version="10.0.0" />
...
````markdown
This project gets generated by bit-bp template v-10.0.0 using the following command
```bash
dotnet new bit-bp
