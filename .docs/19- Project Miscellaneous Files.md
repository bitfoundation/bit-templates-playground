...
```xml
<PackageReference Include="Bit.BlazorUI" Version="10.4.4" />
```
...
```xml
<PackageVersion Include="Bit.BlazorUI" Version="10.4.4" />
```
...
```xml
<PackageVersion Include="Bit.BlazorUI" Version="10.4.4" />
<PackageVersion Include="Bit.Butil" Version="10.4.4" />
...
````markdown
This project gets generated by bit-bp template v-10.4.4 using the following command
```bash
dotnet new bit-bp
