...
Welcome to Stage 22! In this stage, you will learn about the comprehensive **messaging and real-time communication system** built into the Bit.TemplatePlayground project. This system provides multiple communication channels for different scenarios, from in-app component communication to real-time server updates and push notifications.
...
**Location**: [`src/Client/Bit.TemplatePlayground.Client.Core/Services/ClientPubSubMessages.cs`](/src/Client/Bit.TemplatePlayground.Client.Core/Services/ClientPubSubMessages.cs)
...
**SignalR** is ASP.NET Core's real-time communication library that enables bi-directional communication between server and clients. The Bit.TemplatePlayground project uses SignalR to:
...
**Location**: [`src/Server/Bit.TemplatePlayground.Server.Api/SignalR/AppHub.cs`](/src/Server/Bit.TemplatePlayground.Server.Api/SignalR/AppHub.cs)
...
The SignalR hub is configured in [`src/Server/Bit.TemplatePlayground.Server.Api/Program.Middlewares.cs`](/src/Server/Bit.TemplatePlayground.Server.Api/Program.Middlewares.cs):
...
**Location**: [`src/Client/Bit.TemplatePlayground.Client.Core/Extensions/IClientCoreServiceCollectionExtensions.cs`](/src/Client/Bit.TemplatePlayground.Client.Core/Extensions/IClientCoreServiceCollectionExtensions.cs)
