...
**Client-Side Interface**: [`src/Client/Bit.TemplatePlayground.Client.Core/Services/Contracts/IPushNotificationService.cs`](/src/Client/Bit.TemplatePlayground.Client.Core/Services/Contracts/IPushNotificationService.cs)

**Base Implementation**: [`src/Client/Bit.TemplatePlayground.Client.Core/Services/PushNotificationServiceBase.cs`](/src/Client/Bit.TemplatePlayground.Client.Core/Services/PushNotificationServiceBase.cs)
...
**Location**: [`src/Server/Bit.TemplatePlayground.Server.Api/Services/PushNotificationService.cs`](/src/Server/Bit.TemplatePlayground.Server.Api/Services/PushNotificationService.cs)
...
**Extension Helper**: [`src/Client/Bit.TemplatePlayground.Client.Core/Extensions/NotificationExtensions.cs`](/src/Client/Bit.TemplatePlayground.Client.Core/Extensions/NotificationExtensions.cs)
...
* [Describe the workflow of bit Bit.TemplatePlayground's AI chat feature and provide a high-level overview.
