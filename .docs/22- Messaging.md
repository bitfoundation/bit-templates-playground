...
Welcome to Stage 22! In this stage, you will learn about the comprehensive **messaging and real-time communication system** built into the Bit.TemplatePlayground project. This system provides a unified messaging architecture that enables communication across multiple channels and platforms.
...
At the heart of the Bit.TemplatePlayground messaging architecture is **AppMessages** - a centralized messaging system that provides a consistent way to communicate across different parts of your application, regardless of whether the communication happens:
...
The Bit.TemplatePlayground project provides multiple communication channels that all work with the same centralized message system. Let's explore each channel and understand when to use them.
...
**Location**: [`src/Client/Bit.TemplatePlayground.Client.Core/Components/Layout/AppJsBridge.razor.cs`](/src/Client/Bit.TemplatePlayground.Client.Core/Components/Layout/AppJsBridge.razor.cs)
...
The `window.postMessage` API allows communication between different JavaScript contexts (e.g., iframes, service workers). The Bit.TemplatePlayground project bridges this to PubSubService.

**Location**: [`src/Client/Bit.TemplatePlayground.Client.Core/Scripts/events.ts`](/src/Client/Bit.TemplatePlayground.Client.Core/Scripts/events.ts)
...
**Location**: [`src/Client/Bit.TemplatePlayground.Client.Web/wwwroot/service-worker.js`](/src/Client/Bit.TemplatePlayground.Client.Web/wwwroot/service-worker.js)
...
**Location**: [`src/Client/Bit.TemplatePlayground.Client.Core/Components/AppClientCoordinator.cs`](/src/Client/Bit.TemplatePlayground.Client.Core/Components/AppClientCoordinator.cs)
...
The Bit.TemplatePlayground project supports **push notifications** across all platforms:
...
**Client-Side Interface**: [`src/Client/Bit.TemplatePlayground.Client.Core/Infrastructure/Services/Contracts/IPushNotificationService.cs`](/src/Client/Bit.TemplatePlayground.Client.Core/Infrastructure/Services/Contracts/IPushNotificationService.cs)

**Base Implementation**: [`src/Client/Bit.TemplatePlayground.Client.Core/Infrastructure/Services/PushNotificationServiceBase.cs`](/src/Client/Bit.TemplatePlayground.Client.Core/Infrastructure/Services/PushNotificationServiceBase.cs)
...
**Location**: [`src/Server/Bit.TemplatePlayground.Server.Api/Features/PushNotification/PushNotificationService.cs`](/src/Server/Bit.TemplatePlayground.Server.Api/Features/PushNotification/PushNotificationService.cs)
...
**Extension Helper**: [`src/Client/Bit.TemplatePlayground.Client.Core/Infrastructure/Extensions/NotificationExtensions.cs`](/src/Client/Bit.TemplatePlayground.Client.Core/Infrastructure/Extensions/NotificationExtensions.cs)
...
When testing push notifications, it's critical to understand that there are **four distinct scenarios** based on the app state when the notification is sent and when the user taps on it. The Bit.TemplatePlayground project handles all four scenarios across all platforms.
