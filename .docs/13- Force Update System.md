...
Welcome to **Stage 13** of the Bit.TemplatePlayground project getting started guide! In this stage, we'll explore the **Force Update System** - a critical feature that ensures all users are running compatible versions of your application.
...
**File**: [`src/Client/Bit.TemplatePlayground.Client.Core/Infrastructure/Services/HttpMessageHandlers/RequestHeadersDelegatingHandler.cs`](/src/Client/Bit.TemplatePlayground.Client.Core/Infrastructure/Services/HttpMessageHandlers/RequestHeadersDelegatingHandler.cs)
...
**File**: [`src/Client/Bit.TemplatePlayground.Client.Core/Infrastructure/Extensions/IClientCoreServiceCollectionExtensions.cs`](/src/Client/Bit.TemplatePlayground.Client.Core/Infrastructure/Extensions/IClientCoreServiceCollectionExtensions.cs)
...
**File**: [`src/Server/Bit.TemplatePlayground.Server.Api/Infrastructure/RequestPipeline/ForceUpdateMiddleware.cs`](/src/Server/Bit.TemplatePlayground.Server.Api/Infrastructure/RequestPipeline/ForceUpdateMiddleware.cs)
...
**File**: [`src/Server/Bit.TemplatePlayground.Server.Api/appsettings.json`](/src/Server/Bit.TemplatePlayground.Server.Api/appsettings.json)
...
**File**: [`src/Server/Bit.TemplatePlayground.Server.Api/ServerApiSettings.cs`](/src/Server/Bit.TemplatePlayground.Server.Api/ServerApiSettings.cs)
...
**File**: [`src/Client/Bit.TemplatePlayground.Client.Core/Infrastructure/Services/HttpMessageHandlers/ExceptionDelegatingHandler.cs`](/src/Client/Bit.TemplatePlayground.Client.Core/Infrastructure/Services/HttpMessageHandlers/ExceptionDelegatingHandler.cs)
...
**File**: [`src/Client/Bit.TemplatePlayground.Client.Core/Infrastructure/Services/Contracts/IAppUpdateService.cs`](/src/Client/Bit.TemplatePlayground.Client.Core/Infrastructure/Services/Contracts/IAppUpdateService.cs)
...
**File**: [`src/Client/Bit.TemplatePlayground.Client.Windows/Infrastructure/Services/WindowsAppUpdateService.cs`](/src/Client/Bit.TemplatePlayground.Client.Windows/Infrastructure/Services/WindowsAppUpdateService.cs)
...
**File**: [`src/Client/Bit.TemplatePlayground.Client.Maui/Infrastructure/Services/MauiAppUpdateService.cs`](/src/Client/Bit.TemplatePlayground.Client.Maui/Infrastructure/Services/MauiAppUpdateService.cs)
...
**File**: [`src/Client/Bit.TemplatePlayground.Client.Core/Components/Layout/ForceUpdateSnackBar.razor`](/src/Client/Bit.TemplatePlayground.Client.Core/Components/Layout/ForceUpdateSnackBar.razor)
...
**File**: [`src/Client/Bit.TemplatePlayground.Client.Core/Components/Layout/ForceUpdateSnackBar.razor.cs`](/src/Client/Bit.TemplatePlayground.Client.Core/Components/Layout/ForceUpdateSnackBar.razor.cs)
