...
**Location**: [`/src/Client/Bit.TemplatePlayground.Client.Core/Components/Pages/Products/ProductsPage.razor`](/src/Client/Bit.TemplatePlayground.Client.Core/Components/Pages/Products/ProductsPage.razor)
...
**Location**: [`/src/Client/Bit.TemplatePlayground.Client.Core/Components/Pages/Products/ProductsPage.razor.cs`](/src/Client/Bit.TemplatePlayground.Client.Core/Components/Pages/Products/ProductsPage.razor.cs)
...
**Location**: [`/src/Client/Bit.TemplatePlayground.Client.Core/Components/Pages/Products/ProductsPage.razor.scss`](/src/Client/Bit.TemplatePlayground.Client.Core/Components/Pages/Products/ProductsPage.razor.scss)
...
#### Adding to NavBar
**Location**: [`/src/Client/Bit.TemplatePlayground.Client.Core/Components/Layout/NavBar.razor`](/src/Client/Bit.TemplatePlayground.Client.Core/Components/Layout/NavBar.razor)
...
**Location**: [`/src/Client/Bit.TemplatePlayground.Client.Core/Components/Layout/MainLayout.razor.items.cs`](/src/Client/Bit.TemplatePlayground.Client.Core/Components/Layout/MainLayout.razor.items.cs)
...
Some pages need access to native platform features (e.g., device info, native APIs). Instead of placing them in `Bit.TemplatePlayground.Client.Core` and using dependency injection or pub-sub patterns, you can create **platform-specific pages** directly in platform projects.

#### Example: AboutPage

The `AboutPage` demonstrates this pattern by existing in multiple platform projects:
- [`/src/Client/Bit.TemplatePlayground.Client.Maui/Components/Pages/AboutPage.razor`](/src/Client/Bit.TemplatePlayground.Client.Maui/Components/Pages/AboutPage.razor)
- [`/src/Client/Bit.TemplatePlayground.Client.Windows/Components/Pages/AboutPage.razor`](/src/Client/Bit.TemplatePlayground.Client.Windows/Components/Pages/AboutPage.razor)
- [`/src/Client/Bit.TemplatePlayground.Client.Web/Components/Pages/AboutPage.razor`](/src/Client/Bit.TemplatePlayground.Client.Web/Components/Pages/AboutPage.razor)
...
**In `Bit.TemplatePlayground.Client.Maui.csproj`, `Bit.TemplatePlayground.Client.Windows.csproj`, and `Bit.TemplatePlayground.Client.Web.csproj`:**
...
<Target Name="BuildCssFiles">
    <Exec Command="../Bit.TemplatePlayground.Client.Core/node_modules/.bin/sass Components:Components" />
</Target>
```
...
**Location**: [`/src/Client/Bit.TemplatePlayground.Client.Core/Styles/app.scss`](/src/Client/Bit.TemplatePlayground.Client.Core/Styles/app.scss)
...
**Location**: [`/src/Client/Bit.TemplatePlayground.Client.Core/Styles/abstracts/_bit-css-variables.scss`](/src/Client/Bit.TemplatePlayground.Client.Core/Styles/abstracts/_bit-css-variables.scss)
...
**Location**: [`/src/Client/Bit.TemplatePlayground.Client.Core/Components/Pages/AppPageBase.cs`](/src/Client/Bit.TemplatePlayground.Client.Core/Components/Pages/AppPageBase.cs)
