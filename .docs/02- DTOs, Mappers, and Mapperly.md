...
Welcome to **Stage 2** of the Bit.TemplatePlayground project tutorial! In this stage, you'll learn about:
...
**More info**: [Server/Features/Mappers.md](/src/Server/Bit.TemplatePlayground.Server.Api/Features/Mappers.md)
...
**Location**: [`src/Server/Bit.TemplatePlayground.Server.Api/Features/Categories/CategoriesMapper.cs`](/src/Server/Bit.TemplatePlayground.Server.Api/Features/Categories/CategoriesMapper.cs)
...
For reference, here's the entity model: [`Category.cs`](/src/Server/Bit.TemplatePlayground.Server.Api/Features/Categories/Category.cs)
...
**Example from [`CategoryController.cs`](/src/Server/Bit.TemplatePlayground.Server.Api/Features/Categories/CategoryController.cs):**
...
- **Security**: Prevents overposting attacks - a client cannot reach an entity member that has no DTO counterpart. For
  ...
  [`ProductsMapper`](/src/Server/Bit.TemplatePlayground.Server.Api/Features/Products/ProductsMapper.cs), which ignores
...
**Location**: [`AddOrEditCategoryModal.razor.cs`](/src/Client/Bit.TemplatePlayground.Client.Core/Components/Pages/Categories/AddOrEditCategoryModal.razor.cs)
...
**Location**: [`ProfileSection.razor.cs`](/src/Client/Bit.TemplatePlayground.Client.Core/Components/Pages/Settings/ProfileSection.razor.cs)
