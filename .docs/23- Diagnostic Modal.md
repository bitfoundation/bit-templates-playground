...
- Sends a request to [`DiagnosticsController.PerformDiagnostics`](/src/Server/Bit.TemplatePlayground.Server.Api/Features/Diagnostics/DiagnosticsController.cs)
