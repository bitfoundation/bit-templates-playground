...
- **Filter by Category**: Multi-select dropdown showing all log categories (e.g., `Microsoft.EntityFrameworkCore`, `Bit.TemplatePlayground.Client.Core.Services`)
...
- Sends a request to [`DiagnosticsController.PerformDiagnostics`](/src/Server/Bit.TemplatePlayground.Server.Api/Controllers/Diagnostics/DiagnosticsController.cs)
