...
✓ Builds entire solution (Bit.TemplatePlayground.slnx)
...
2. **Build & Package with Velopack**
   ...
   dotnet vpk pack \
     ...
     -e Bit.TemplatePlayground.Client.Windows.exe \  # Main executable
     -r win-x86 \                   # Runtime
...
1. **Setup Android Signing**
   ...
   - Save as Bit.TemplatePlayground.keystore in project directory
...
dotnet publish -c Release \
  ...
  -p:AndroidSigningKeyStore="Bit.TemplatePlayground.keystore" \
  -p:AndroidSigningKeyAlias=Bit.TemplatePlayground \
