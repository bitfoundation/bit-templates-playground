...
**`WebAuthnCredential` Entity** (`Bit.TemplatePlayground.Server.Api/Models/Identity/WebAuthnCredential.cs`):
...
**`WebAuthnServiceBase`** (`Bit.TemplatePlayground.Client.Core/Services/WebAuthnServiceBase.cs`):
...
**`ILocalHttpServer`** Interface (`Bit.TemplatePlayground.Client.Core/Services/Contracts/ILocalHttpServer.cs`):
...
**Location**: `Bit.TemplatePlayground.Client.Web/wwwroot/web-interop-app.html`
