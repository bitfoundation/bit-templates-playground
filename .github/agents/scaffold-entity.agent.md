...
description: Scaffolds a complete CRUD entity across every layer of the Bit.TemplatePlayground solution - entity model, EF Core configuration and migration, DTO, Mapperly mapper, API controller, IAppController interface, AppStrings resource entries, Blazor grid and add/edit pages, and navigation integration.
---
...
### Entity (Model)
- **Location**: `src/Server/Bit.TemplatePlayground.Server.Api/Features/{FeatureName}/`
- **File**: `{EntityName}.cs`
- **Requirements**:
...
- **Migration**: 
  - Run: `dotnet ef migrations add {MigrationName} --output-dir Infrastructure/Data/Migrations --verbose` in `Bit.TemplatePlayground.Server.Api` project
...
**Location**: `src/Client/Bit.TemplatePlayground.Client.Core/Components/Pages/{FeatureName}/`
