...
A deliberately global entity is the one exception the **scaffold-entity** skill (`.github/agents/scaffold-entity.agent.md`) allows; flag it anyway, so the intent gets stated rather than assumed
