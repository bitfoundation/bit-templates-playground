...
Notes:
* `app` is an abbreviation for Bit.TemplatePlayground, use the acronym of your choice and replace app with that (for example abc) using exact match - case sensitive find and replace in this file and AdStack.cs.
...
pulumi config set Bit.TemplatePlayground.Iac:sql-server-app-db-admin-id
pulumi config set Bit.TemplatePlayground.Iac:sql-server-app-db-admin-password --secret
