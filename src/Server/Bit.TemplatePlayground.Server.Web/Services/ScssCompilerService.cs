...
public class ScssCompilerService
{
    internal static async Task WatchScssFiles(WebApplication app)
    {
        ...
        var clientCorePath = Path.Combine(Environment.CurrentDirectory, "../../Client/Bit.TemplatePlayground.Client.Core");
        ...
        // but uses ../../Client/Bit.TemplatePlayground.Client.Web:../../Client/Bit.TemplatePlayground.Client.Web instead of .:.,
        ...
        if (Path.Exists(Path.Combine(Environment.CurrentDirectory, "../../Client/Bit.TemplatePlayground.Client.Maui/Components")))
            sassPathsToWatch.Add("../../Client/Bit.TemplatePlayground.Client.Maui/Components:../../Client/Bit.TemplatePlayground.Client.Maui/Components");

        if (Path.Exists(Path.Combine(Environment.CurrentDirectory, "../../Client/Bit.TemplatePlayground.Client.Windows/Components")))
            sassPathsToWatch.Add("../../Client/Bit.TemplatePlayground.Client.Windows/Components:../../Client/Bit.TemplatePlayground.Client.Windows/Components");

        if (Path.Exists(Path.Combine(Environment.CurrentDirectory, "../../Client/Bit.TemplatePlayground.Client.Web/Components")))
            sassPathsToWatch.Add("../../Client/Bit.TemplatePlayground.Client.Web/Components:../../Client/Bit.TemplatePlayground.Client.Web/Components");
