...
public static class WebApplicationExtensions
{
    extension(WebApplication app)
    {
        ...
        // - src/Client/Bit.TemplatePlayground.Client.Web/wwwroot/_headers (Cloudflare Pages)
        // - src/Client/Bit.TemplatePlayground.Client.Web/wwwroot/staticwebapp.config.json (Azure Static Web Apps)
        // - src/Client/Bit.TemplatePlayground.Client.Maui/Platforms/Android/AppWebChromeClient.cs (Permissions-Policy only)
