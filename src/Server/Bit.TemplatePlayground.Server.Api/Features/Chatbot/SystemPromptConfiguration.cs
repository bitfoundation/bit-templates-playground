...
- Car must be clearly visible as the main subject";
    ...
    {
        return @"You are Ava, the assistant for the Bit.TemplatePlayground app. Below, you will find a markdown document containing information about the app, followed by the user's query.
