...
public partial class ProductConfiguration : IEntityTypeConfiguration<Product>
{
    public void Configure(EntityTypeBuilder<Product> builder)
    {
        ...
        DateTimeOffset baseDate = DateTimeOffset.Parse("2025-04-22", styles: DateTimeStyles.AssumeUniversal);
        ...
        builder.HasData(new
        {
            ...
            CategoryId = Guid.Parse("6fae78f3-b067-40fb-a2d5-9c8dd5eb2e08"),
            ShortId = 10000,
        ...
        builder.HasData(new
        {
            ...
            CreatedOn = baseDate.AddDays(-10),
            CategoryId = Guid.Parse("31d78bd0-0b4f-4e87-b02f-8f66d4ab2845"),
            ShortId = 10020,
            ConcurrencyStamp = defaultConcurrencyStamp,
            HasPrimaryImage = false
        });
        ...
        builder.HasData(new
        {
            ...
            CreatedOn = baseDate.AddDays(-10),
            CategoryId = Guid.Parse("582b8c19-0709-4dae-b7a6-fa0e704dad3c"),
            ShortId = 10028,
            ConcurrencyStamp = defaultConcurrencyStamp,
            HasPrimaryImage = false
        });
        ...
        builder.HasData(new
        {
            ...
            CreatedOn = baseDate.AddDays(-10),
            CategoryId = Guid.Parse("ecf0496f-f1e3-4d92-8fe4-0d7fa2b4ffa4"),
            ShortId = 10036,
            ConcurrencyStamp = defaultConcurrencyStamp,
            HasPrimaryImage = false
        });
        ...
        builder.HasData(new
        {
            ...
            CreatedOn = baseDate.AddDays(-10),
            CategoryId = Guid.Parse("747f6d66-7524-40ca-8494-f65e85b5ee5d"),
            ShortId = 10044,
            ConcurrencyStamp = defaultConcurrencyStamp,
            HasPrimaryImage = false
        });
