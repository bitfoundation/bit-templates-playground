...
namespace Bit.TemplatePlayground.Server.Api.Data.Migrations
{
    ...
    [Migration("20250807145738_Inital")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bit.TemplatePlayground.Server.Api.Models.Attachments.Attachment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Bit.TemplatePlayground.Server.Api.Models.Chatbot.SystemPrompt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Bit.TemplatePlayground.Server.Api.Models.Identity.RoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Bit.TemplatePlayground.Server.Api.Models.Identity.UserClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Bit.TemplatePlayground.Server.Api.Models.Identity.UserLogin", b =>
                {
            ...
            modelBuilder.Entity("Bit.TemplatePlayground.Server.Api.Models.Identity.UserRole", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Bit.TemplatePlayground.Server.Api.Models.Identity.UserSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Bit.TemplatePlayground.Server.Api.Models.Identity.UserToken", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Bit.TemplatePlayground.Server.Api.Models.Identity.WebAuthnCredential", b =>
                {
                    b.Property<byte[]>("Id")
                        .HasColumnType("BLOB");
            ...
            modelBuilder.Entity("Bit.TemplatePlayground.Server.Api.Models.Products.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = new byte[] { 0, 0, 0, 0, 0, 0, 0, 0 },
                            CreatedOn = 1308451995648000000L,
            ...
            modelBuilder.Entity("Bit.TemplatePlayground.Server.Api.Models.Identity.RoleClaim", b =>
                {
                    b.HasOne("Bit.TemplatePlayground.Server.Api.Models.Identity.Role", "Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Bit.TemplatePlayground.Server.Api.Models.Identity.UserClaim", b =>
                {
                    b.HasOne("Bit.TemplatePlayground.Server.Api.Models.Identity.User", "User")
                        .WithMany("Claims")
